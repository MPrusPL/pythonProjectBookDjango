...
def book_search(request):
    ...
    if form.is_valid() and form.cleaned_data['search']:
        ...
        search_in = form.cleaned_data.get('search_in') or 'title' or 'publisher'
        if search_in == 'title':
            books = Book.objects.filter(title__icontains=search)
        elif search_in == 'publisher':
            names_publisher = Publisher.objects.filter(name__icontains=search)
            for publisher in names_publisher:
...
def test_page(request):
    ...
    context = {'book': book}
    return render(request, 'reviews/test_page.html', context)
...
def publisher_edit(request, pk=None):
    ...
    return render(request, 'reviews/instance_form.html', {'instance': publisher, 'model_type': 'Publisher', 'form': form})
...
def review_edit(request, book_pk, review_pk=None):
    ...
    return render(request, 'reviews/instance_form.html', {'instance': review, 'model_type': 'Review', 'form':form, 'related_model_type': 'Book', 'related_instance': book})
...
def book_media(request, pk):
    ...
    return render(request, 'reviews/instance_form.html', {'form': form, 'model_type': 'Book', 'instance': book, 'is_file_upload': True})
