...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role', models.CharField(choices=[('Author', 'AUTHOR'), ('Co-author', 'CO_AUTHOR'), ('Editor', 'EDITOR')], max_length=20, verbose_name='Rola, jaką współtwórca odegrał podczas tworzenia tej książki. ')),
